...
🔗 Live demo: bloodlink-s5d7.onrender.com 
...
Frontend: React 19, Vite, React Router 7, Axios Backend: Node.js, Express 4, MongoDB + Mongoose 8, JWT, bcryptjs Deployment: Render
...
Requirements: Node.js 18+, npm, a MongoDB connection string (Atlas or local)
